...
const studentsData = [
  { id: 1, img: "", admissionNo: 191, name: "Rebecca Burns", rollNo: 40, gender: "Female", class: "Six", fatherPhone: "871", paymentStatus: "Paid" },
  { id: 2, img: "", admissionNo: 12, name: "Gautam Raj", rollNo: 5, gender: "Male", class: "Six", fatherPhone: "09508309369", paymentStatus: "Pending" },
  { id: 3, img: "", admissionNo: 13, name: "Madan Singh", rollNo: 6, gender: "Male", class: "Six", fatherPhone: "8228843872", paymentStatus: "Paid" },
];
          ...
          <TableBody>
            {filteredStudents.map(student => (
              <TableRow key={student.id}>
                <TableCell><img src={student.img || "https://via.placeholder.com/40"} className="w-10 h-10 rounded-full" /></TableCell>
                ...
                <TableCell className={student.paymentStatus === "Pending" ? "text-red-500" : "text-green-500"}>{student.paymentStatus}</TableCell>
